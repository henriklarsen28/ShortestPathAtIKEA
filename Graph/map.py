...
def makeGraph():
    ...
    G.add_node("1_1", pos=(0.7, -1), weight=1.6)
    G.add_node("1_2", pos=(0.4, -1), weight=1.5)
    G.add_node("1_3", pos=(0.1, -1), weight=1.4)
    G.add_node("1_4", pos=(-0.2, -1), weight=1.3)

    G.add_node("3_1", pos=(0.7, -1.5), weight=2.1)
    G.add_node("3_2", pos=(0.4, -1.5), weight=2)
    G.add_node("3_3", pos=(0.1, -1.5), weight=1.9)
    G.add_node("3_4", pos=(-0.2, -1.5), weight=1.8)

    G.add_node("2_1", pos=(1.3, -1), weight=2)
    G.add_node("2_2", pos=(1.6, -1), weight=2.3)
    G.add_node("2_3", pos=(1.9, -1), weight=2.6)
    G.add_node("2_4", pos=(2.2, -1), weight=2.9)

    G.add_node("4_1", pos=(1.3, -1.5), weight=2.5)
    G.add_node("4_2", pos=(1.6, -1.5), weight=2.7)
    G.add_node("4_3", pos=(1.9, -1.5), weight=2.9)
    G.add_node("4_4", pos=(2.2, -1.5), weight=3.1)
    ...
    G.add_edge("SelfServeHall", "2_1", weight=0.5)
    G.add_edge("2_1", "2_2", weight=0.5)
    G.add_edge("2_2", "2_3", weight=0.5)
    G.add_edge("2_3", "2_4", weight=0.5)
    G.add_edge("2_1", "4_1", weight=0.5)
    G.add_edge("4_1", "4_2", weight=0.5)
    G.add_edge("4_2", "4_3", weight=0.5)
    G.add_edge("4_3", "4_4", weight=0.5)
    ...
    G.add_edge("1_1", "2_1", weight=1)
    G.add_edge("3_1", "4_1", weight=1)

    G.add_edge("SelfServeHall", "Exit", weight=1.2)

    G.add_edge("3_1", "Exit", weight=0.5)
    G.add_edge("4_1", "Exit", weight=0.5)
    ...
    # Draw the graph
    nx.draw(G, pos, with_labels=True, node_size=100, node_color='lightblue', font_size=7, edge_color='gray')
...
def aStarCalculations(G, source, dest, cart):
    ...
    listOfLocations = [source]
    for item in cart:
        if item["selfServe"] == True:
            listOfLocations.append(f"{item['aile']}_{item['bin']}")
        else:
            listOfLocations.append(item["location"])
    listOfLocations.append(dest)
